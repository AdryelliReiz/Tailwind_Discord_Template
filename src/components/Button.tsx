...
export function Button({icon, description, style}: AutoButtonPros) {
    return (
        <div>
            <button className={`button-hover relative w-[32px] h-[32px] flex items-center justify-center rounded-md text-gray-400 hover:bg-gray-700 hover:text-gray-50 group ${style}`} >
                {icon}
